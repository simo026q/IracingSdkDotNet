...
public class DriverModel
{
    ...
    public string CarIsElectric { get; set; }// %d
    ...
    public int DivisionID { get; set; } // Might be deprecated
    public string ClubName { get; set; } // Might be deprecated
    public int ClubID { get; set; } // Might be deprecated
    public string DivisionName { get; set; } // Might be deprecated
}
